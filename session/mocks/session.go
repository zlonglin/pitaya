...
func (m *MockSession) Kick(arg0 context.Context, v interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockSessionMockRecorder) Kick(arg0 interface{}, v interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Kick", reflect.TypeOf((*MockSession)(nil).Kick), arg0, v)
}
