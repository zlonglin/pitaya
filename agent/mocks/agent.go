...
func (m *MockAgent) Kick(arg0 context.Context, v interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockAgentMockRecorder) Kick(arg0 interface{}, v interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Kick", reflect.TypeOf((*MockAgent)(nil).Kick), arg0, v)
}
